...
# ==========================================
config_path = "ssd_mobilenet_v1_fpn_640x640_coco17_tpu-8_config.yaml"

with open(config_path, "r") as f:
    config = yaml.safe_load(f)

preprocess_opts = config.get('preprocessing', {})
crop_size = preprocess_opts.get('crop_size', [640, 640]) 
...
# ==========================================
model_path = "ssd_mobilenet_v1_fpn_640x640_coco17_tpu-8.tflite"
